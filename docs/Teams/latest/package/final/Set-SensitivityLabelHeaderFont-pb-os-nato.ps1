...
.DESCRIPTION
    ...
    content marking on the "Protected B - Official Sensitive - NATO" sensitivity label.
...
.EXAMPLE
    .\Set-SensitivityLabelHeaderFont.ps1
#>
...
$HeaderFontSize  = 14
$HeaderFontColor = "#A80000"  # Dark Red
...
Write-Host "  Font Color: $HeaderFontColor (Dark Red)" -ForegroundColor White
Write-Host ""
...
Write-Host "  Color:      $HeaderFontColor (Dark Red)" -ForegroundColor White
Write-Host ""
