...
|-------|---------|--------------|
| **Protected B - Official Sensitive - NATO** | Classified content, contracts, PII | Applies encryption, restricts forwarding |
...
**When in doubt → Choose Protected B - Official Sensitive - NATO**

| Always Protected B - Official Sensitive - NATO | General/Unclassified is OK |
|-------------------|---------------------------|
