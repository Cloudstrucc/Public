...
| **Audience** | All Leonardo Canada Employees |
...
- **Protected B - Official Sensitive - NATO** = Top Secret meeting room with guards and cameras
- **Unclassified** = Open conference room

### What This Means for You

Starting **December 4, 2025**, as we roll out the new security features in our M365 tenant, every time you create a Teams meeting, you'll be prompted to choose a label that determines:
- Who can join
- Who can present
...
Leonardo Canada is a **defense contractor** that handles:
...
- Private key management (we control the encryption keys for sovereignty purposes)
...
### 🔴 Protected B - Official Sensitive - NATO
...
| **Encryption** | Standard | Teams default encryption with CMK |
...
```
Click: "New meeting" button (top right) - or "New" with the new version of Outlook (which needs to be configured to comply with these new security features)
```

**Step 3: Notice the labels**
```
You'll see:
  Sensitivity: [Protected B - Official Sensitive - NATO ▼]
               [Unclassified]
...
```
Check that "Protected B - Official Sensitive - NATO" is still selected
```
...
Should show: "Protected B - Official Sensitive - NATO"
```
...
Select: "Protected B - Official Sensitive - NATO"
```
...
Here's how to change it for casual meetings:

### Step-by-Step

**Step 1: Create Meeting as Normal**
```
Calendar → "New" (using new version of outlook)
```

**Step 2: Click Sensitivity Dropdown**
```
Click on: "Protected B - Official Sensitive - NATO ▼"
         (the dropdown arrow)
```

**Step 3: Select Unclassified**
```
Click: "Unclassified"
```
...
```
Sensitivity now shows: "Unclassified"
```
...
│ Title: [Team Standup            ]     │
│                                         │
│ Sensitivity: [Unclassified - Regular    ▼] │ ← Changed!
└─────────────────────────────────────────┘
```
...
Will you discuss ANY of these?
  ...
  ↓
┌─ YES → Protected B - Official Sensitive - NATO 🔴
│
└─ NO → Ask: Is it purely social/administrative?
         ↓
      ┌─ YES → Unclassified 🟢
      │
      └─ UNSURE → Protected B - Official Sensitive - NATO 🔴
...
**Training:**
- ✅ Unclassified IT training
- ✅ Professional development (non-classified)
- ✅ Software tutorials
- ✅ Onboarding for Unclassified company info
- ✅ Safety training (non-sensitive)

**Public Content:**
- ✅ Webinars open to public
- ✅ Marketing presentations
- ✅ Town halls with Unclassified announcements
...
### In a Protected B - Official Sensitive - NATO Meeting
...
2. **Lobby Restrictions**
   ...
   Note: You'll see this, but they can't actually join (unless you select them and press add as attendee or presenter)
         (blocked by policy)
   ```
...
| Setting | Protected B 🔴 | Unclassified 🟢 |
|---------|---------------|-----------|
...
**Steps:**
1. Create meeting
2. Change label to "Unclassified"
...
**Choose:** 🔴 Protected B - Official Sensitive - NATO

**Steps:**
1. Create meeting
2. Keep default "Protected B - Official Sensitive - NATO"
3. Add only cleared personnel as attendees
4. Send invite

**During meeting:**
- Watermarks on all screen shares and transcripts
- Only org members can join the lobby directly
- External users must be explicitly allowed in by the Organizer (or co-organizer) by selecting add as attendee to the user waiting in the lobby
...
**Meeting:** Product demo for potential customer (Unclassified marketing material)

**Choose:** 🟢 Unclassified

**Steps:**
1. Create meeting
2. Change to "Unclassified"
...
**Steps:**
1. Create meeting
2. Keep "Protected B - Official Sensitive - NATO"
...
- Want to switch from Protected B to Unclassified
...
**This is BY DESIGN** - Protected B blocks external users unless explicitly granted permissions by the organizer / co organizer from the invitation lobby only.

**Options:**

**Option 1: Use Unclassified Meeting (If Content Appropriate)**
```
If meeting content is NOT sensitive:
1. Cancel Protected B meeting
2. Create new Unclassified meeting
...
**Tip 2: Use Unclassified Meeting**
```
If content is NOT sensitive:
- Use Unclassified meeting instead
- No watermarks
...
A: Yes. Label usage is mandatory for all meetings one the feature is avaialble on your machine 
   containing sensitive information. It's a compliance requirement, not optional.

**Q: What if I forget to use a label?**
A: Good news! it is mandatory to select a label.
...
A: Meetings created before the rollout will continue to work as they currently do. 
...
A: Always use Protected B - Official Sensitive - NATO when in doubt. It's better to be 
   overly cautious with sensitive information.

**Q: Can I use Unclassified for meetings with government representatives?**
...
A: Using Unclassified for sensitive discussions may trigger security reviews and could 
   result in:
...
A: Options:
   ...
   Do NOT downgrade to Unclassified meeting just to accommodate external access!
...
A: For customer meetings:
   - Sales/marketing discussions: Unclassified meeting ✓
...
A: For company-wide meetings:
   - Unclassified announcements: Unclassified meeting
...
A: Ask your boss about meeting content:
   ...
   - Casual/administrative: Unclassified
...
**Label Selection:**
- ❌ Don't use Unclassified just because it's "easier"
- ❌ Don't downgrade to Unclassified to bypass restrictions
...
- ❌ Don't discuss classified info in Unclassified meetings (!)

**External Collaboration:**
- ❌ Don't create Unclassified meetings just so external can join
- ❌ Don't share sensitive information in Unclassified meetings
...
Any "Yes" → Protected B - Official Sensitive - NATO
All "No" → Can use Unclassified
```
...
✓ "Team Coffee Break (Unclassified)"
✓ "Engineering Design Review - CLASSIFIED"
✓ "Training: New Timesheet System (Unclassified)"
```
...
**Two Labels:**
- 🔴 Protected B - Official Sensitive - NATO → Classified/sensitive content
- 🟢 Unclassified → Casual/administrative content

**When in Doubt:**
→ Use Protected B - Official Sensitive - NATO

**Key Differences:**
- Protected B - Official Sensitive - NATO: Watermarks ON, External blocked, Settings locked 🔒
- Unclassified: No watermarks, External allowed, Settings flexible ✏️
---
