...
| Conditional Access & MFA Setup     | Configure policies, guest restrictions                               | \$5,500                | October 6, 2025       |
| Meeting & Collaboration Hardening  | Meeting options, lobby, link lockdown                                | \$5,000                | October 10, 2025      |
| DLP, Sensitivity Labels, IBs       | Purview config, segmenting                                           | \$6,500                | November 7, 2025      |
| CMK & Private Endpoint Support     | Azure setup, encryption config                                       | \$7,000                | October 22, 2025      |
| Audit, Defender XDR Integration    | Logging, detection, incident setup                                   | \$4,000                | November 7, 2025      |
| Documentation & Knowledge Transfer | Wiki + live walkthroughs / training                                  | \$3,500                | November 14, 2025     |
| Rollout                            | Apply policies to company staff (all),<br />post production test run | N/A                    | November 17-20, 2025  |
| Support (60 days)                  | Response, tuning, questions                                          | \$2,500                | Week of November 20th |
| **Subtotal**                 |                                                                      | **\$38,500 CAD** |                       |
| HST (13%)                          |                                                                      | **\$5,005 CAD**  |                       |
